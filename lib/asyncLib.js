...
// Dynamcally exports getValueA, getValueB, getValueC, getValueD
var values = ['A','B','C', 'D'];
...
function logResolvedValues(resolvedFromPromiseDotAll) {
  console.log([
    '',
...
function filterValuesFromCollection(collection) {
...
function doMoreAsyncWorkWithFilteredValues(collection) {
  console.log([
    '',
